...
| [`tools/larp_recon0_audit.py`](tools/larp_recon0_audit.py) | 확신 출처 장부 검산 — 결론의 확신이 새 증거·반박 복원·재해석 중 어디서 왔는지의 부기를 코드로 확인 |
...
**저작자 채수양** · **[CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/)** (저작자표시-비영리-동일조건변경허락). 출처를 밝히면 자유롭게 공유·수정할 수 있고, 영리 목적 사용은 제외되며, 2차 저작물도 같은 라이선스를 따릅니다. 전문은 [`LICENSE`](LICENSE) 참조.
